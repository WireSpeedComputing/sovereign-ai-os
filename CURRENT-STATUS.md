...
| [Household OS](https://github.com/jryski/Household-OS/pull/4) | Boot-gated operator read command in draft PR 4; 68 local offline tests pass | Code review and authorized client integration; not yet a deployed mobile fix |
